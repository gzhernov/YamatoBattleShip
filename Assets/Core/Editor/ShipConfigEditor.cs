...
public class ShipConfigEditor : Editor
{
    ...
    private SerializedProperty smokeVfxConfig;
    ...
    private void OnEnable()
    {
        ...
        smokeVfxConfig = serializedObject.FindProperty("smokeVfxConfig");
    ...
    public override void OnInspectorGUI()
    {
        ...
        DrawSection(
            ...
            () =>
            {
                ...
                EditorGUILayout.PropertyField(smokeVfxConfig);
    ...
    private string BuildEngineTelegraphSummary()
    {
        ...
        string smokeVfxConfigName = smokeVfxConfig.objectReferenceValue != null
            ? smokeVfxConfig.objectReferenceValue.name
            : "smoke vfx not assigned";

        return $"{configName}, {audioConfigName}, {soundConfigName}, {simpleSoundConfigName}, {smokeVfxConfigName}, initial {GetEnumDisplayName(initialEngineTelegraphSector)}";
    }
